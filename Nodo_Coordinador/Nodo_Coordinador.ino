...
<head>
  ...
  <style>
    ...
    .card.button { background-color: #4CAF50; /* Green */ border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;
}
  </style>
</head>
<body>
  ...
  <div class="content">
    <div class="cards">
      ...
      <div class="card.button">
        <p class="card-title"><i class="fas fa-power-off"></i> ZONA 1 - RIEGO</p> <button onClick=location.href='./?BOMBA1=Encendida'>ENCENDER</button>
      </div>
      <div class="card.button">
        <p class="card-title"><i class="fas fa-power-off"></i> ZONA 1 - RIEGO</p> <button onClick=location.href='./?BOMBA1=APAGADA'>APAGAR</button>
      </div>
      
      <div class="card.button">
        <p class="card-title"><i class="fas fa-power-off"></i> ZONA 2 - RIEGO</p>  <button onClick=location.href='./?BOMBA2=ENCENDIDA'>ENCENDER</button>
      </div>
      <div class="card.button">
        <p class="card-title"><i class="fas fa-power-off"></i> ZONA 2 - RIEGO</p> <button onClick=location.href='./?BOMBA2=APAGADA'>APAGAR</button>
      </div>
      ...
      <div class="card humedadsuelo">
        <p class="card-title"><i class="fas fa-tint"></i> NODO 2 - HUMEDAD DEL SUELO</p><p><span class="reading"><span id="s2"></span> </span></p><p class="timestamp">Ultima lectura: <span id="rs2"></span></p>
      </div>
    </div>
  </div>
<script>
